...
- TCP/ IP 프로토콜 스택이란?
    ...
    ![프로토콜 스택](https://raw.githubusercontent.com/hyeily0627/Basic-TCP-IP-2024/main/images/001.png)

- TCP/ IP 프로토콜 스택 4계층(94p)
    - Link 계층
        - 물리적인 영역의 표준화 결과
    ...
    - TCP/UDP 계층 
        ...
        - TCP는 데이터의 전송을 보장하는 프로토콜(신뢰성 있는 프로토콜), UDP는 보장하지않는 프로토콜

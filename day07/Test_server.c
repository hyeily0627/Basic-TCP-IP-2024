...
char webpage[] = "HTTP/1.1 200 OK\r\n" 
                 ...
                 "<!DOCTYPE html>\r\n" 
                 "<html><head><title> My HYEJIN Web Page </title>\r\n"
                 "<link rel=\"icon\" href=\"data:,\">\r\n"
                 "<style>body {background-color: #A9E2F3 }</style></head>\r\n"
                 "<body><center><h1>Hello! It Hyejin's Page(´▽`ʃ♡ƪ)</h1><br>\r\n"
                 "<img src=\"zzang.jpeg\"></center></body></html>\r\n";
...
int main(int argc, char *argv[])
{
   ...
   while(1) {
      ...
      if(strstr(buf, "GET /zzang.jpeg") != NULL) {
      fdimg = open("zzang.jpeg", O_RDONLY);
